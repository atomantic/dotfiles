...
defaults write NSGlobalDomain AppleHighlightColor -string "1 0.8 0.2"
...
# dont have this problem now, maybe later ? TODO
...
# Set Flurry screensaver to default
...
# TODO look at this later it may prove useful, goto the source to get the rest, its been deleted
...
# TODO - goto the repo and figure out colors for the terminal app, its been deleted.
...
# TODO - setup spectacle to my liking then run the following script to export the settings into defaults write format.
# saved script in same directory as this file, also can be seen on github at - https://github.com/MoOx/setup/blob/master/preferences/Spectacle.backprefs
