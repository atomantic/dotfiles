...
# @author Adam Eivy
# @modifier Marko Boskovic
###########################
# TODO: REMOVE require_brew methods and implement Brewfile
...
# TODO: add here Brewfile install
...
if [[ ! -d "./oh-my-zsh/custom/themes/spaceship" ]]; then
